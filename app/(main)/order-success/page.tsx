...
// ✅ Centralized API helper imports (unchanged)
import {
  fetchUserProfile,
  fetchUserPoints,
  createOrder,
      ...
      .on(
        ...
        (payload) => {
          ...
          if (newStatus === "accepted") {
            toast.success(
              "Admin accepted your order! You can now proceed to payment."
            );
          }
          if (newStatus === "denied") {
            toast.error("Your order was denied by admin.");
          }
        }
      )
      .subscribe();
          ...
          <div className="lg:col-span-2">
            ...
            {step === "payment" && pendingOrder && (
              <div className="bg-card border rounded-lg p-6">
                ...
                {paymentMethod === "card" ? (
                  // Card flow: show card fields always but button behaviour controlled by orderId + orderStatus
